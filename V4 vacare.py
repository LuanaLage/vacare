...
# Template Base - Cores 100% corrigidas para a paleta Terracota (#DD7938) e Salmão (#FF7E70)
...
<head>
    ...
    <style>
        ...
        .search-container {
            background: #ffffff;
            border-radius: 16px;
            box-shadow: 0 8px 30px rgba(221, 121, 56, 0.06);
            padding: 25px;
        }
        .search-title {
            color: var(--terracota);
        ...
        .form-control-custom:focus {
            ...
            box-shadow: 0 0 0 0.25rem rgba(221, 121, 56, 0.15);
        }
        .btn-search {
        ...
        .wp-card:hover {
            ...
            box-shadow: 0 12px 24px rgba(221, 121, 56, 0.08);
        }
...
<body>
    ...
    <!-- Main Header Bar (3 Categorias: Logo/Home, Sobre Nós, Contato) -->
    ...
    <!-- Footer Contendo APENAS o Solicitado -->
...
def index():
    content = """
    <!-- Caixa de Busca CVC Style em Laranja Terracota -->
    ...
    <!-- Cards Clicáveis Worldpackers Style -->
    <main class="container my-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            ...
            <!-- Modal de Detalhes Completo - Estilo Airbnb / Mercado Livre com Reputação e Detalhes solicitados -->
                        ...
                        <div class="modal-body p-4 bg-white">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 border-start">
                                    ...
                                    <!-- Sistema de Reputação Estilo Airbnb/Mercado Livre -->
